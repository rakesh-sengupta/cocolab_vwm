...
**v0.1.0** — initial release. Single OCOS layer, two-layer hierarchy with
cross-talk gated feedback, change-detection task driver, full test suite.

Planned for v0.2: max-pooling feedforward maps, BG-thalamus action selection,
pulvinar blackboard, semantic-pointer feature binding.
