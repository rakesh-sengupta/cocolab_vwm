...
class HierarchyParams:
    ...
    ----------
    layer_params
        OCOS parameters used at each layer (currently identical across layers).
    feedback_levels
        Dict mapping integer feedback depth L to fraction A(L) of p-lattice
        visible. Defaults match Sengupta (2025): A(1)=0.3, A(2)=0.7, A(3)=1.0.
    cross_talk_B
